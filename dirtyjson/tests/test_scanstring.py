...
class TestScanString(TestCase):
    ...
    def test_py_scanstring(self):
        self._test_scanstring(dirtyjson.decoder.py_scanstring)
    ...
    def test_overflow(self):
        ...
        self.assertRaises(OverflowError, dirtyjson.decoder.scanstring, "xxx",
                          maxsize + 1)

    def test_surrogates(self):
        scanstring = dirtyjson.decoder.scanstring
